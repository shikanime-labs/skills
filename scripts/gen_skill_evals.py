    ...
    return {
        ...
        "evals": [
            ...
            {  # positive: explicit procedure request
                ...
                "expected_output": f"SKILL.md exposes an actionable procedure (a '## Steps' or '## Procedure' section with substance).",
                "files": [],
                "assertions": [
                    "Body contains a '## Steps' heading OR a '## Procedure' heading",
