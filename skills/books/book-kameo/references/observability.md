...
Kameo ships a terminal UI for monitoring a running actor system: live
supervision tree, throughput, mailbox backpressure, restarts, deadlocks.
...
- Connect: `kameo-console 127.0.0.1:9999`; try without an app via `kameo-console
  --demo`.
- Full feature list/keybindings: console README
  (`github.com/tqwewe/kameo/tree/main/console`).
