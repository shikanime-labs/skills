...
- llama.cpp requires the
  [GGUF](https://github.com/ggml-org/ggml/blob/master/docs/gguf.md) format.
  Convert other formats with the `convert_*.py` scripts in the repo.
