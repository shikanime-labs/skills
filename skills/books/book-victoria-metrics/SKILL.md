...
- references/key-concepts.md — mental models: metrics, samples, time series,
  storage, global query view, scrape vs push
...
- references/ingest-integrations.md — Prometheus, Grafana, InfluxDB, Graphite,
  OpenTSDB, OTel, DataDog, NewRelic, Zabbix
