...
- Official: `@vitejs/plugin-vue`, `@vitejs/plugin-vue-jsx`,
  `@vitejs/plugin-react` (Oxc transformer, Fast Refresh),
  `@vitejs/plugin-react-swc` (SWC in dev), `@vitejs/plugin-rsc` (React Server
  Components), `@vitejs/plugin-legacy` (legacy browser support).
