...
name: caveman-commit
description:
  "Use when writing a commit message in caveman mode: Conventional Commits compressed to intent — imperative subject, why-only body, no fluff."
version: 0.1.0
author: Hermes Agent
license: Apache-2.0
platforms:
...
- "Generated with <agent name>" or any AI attribution — unless the user's own
  rule requires an `Assisted-by` /AI-attribution trailer, then add it as a
  trailer
