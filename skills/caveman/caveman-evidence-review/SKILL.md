...
description:
  "Use when reviewing Caveman Cloud evidence read-only — cost, Cave Score, workflows, traces, latency, errors, savings — from current data, never repository guesses."
version: 0.1.0
author: Hermes Agent
license: Apache-2.0
platforms:
...
Possible action:
- <proposal only; use caveman-manage for read-only lifecycle
