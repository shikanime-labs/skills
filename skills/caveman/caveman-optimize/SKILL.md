...
description:
  "Use when evaluating a Caveman optimization observation: operator-chosen candidate, paired baseline eval, report observations — never savings."
version: 0.1.0
author: Hermes Agent
license: Apache-2.0
platforms:
...
Accounting: report-only profile; $0 opportunity band;
no inferred or verified savings
