...
No acceptance criteria, no `- [ ]` tasklist — that belongs in the derived
issue. The discussion converges on the problem; the issue carries the gate.
English bodies only (no French).
