...
name: sk-doc
description:
  "Use when documenting a shikanime project in the repo's docs/ directory: seed
  internal-ops and optional user-facing zones, edited as reviewable in-repo
  Markdown."
version: 0.3.0
author: Hermes Agent
license: Apache-2.0
...
metadata:
  hermes:
    tags:
      ["github", "documentation", "docs", "shikanime-labs", "shikanime-studio"]
    related_skills: ["sk-issue", "sk-pr", "sk-land"]
---
