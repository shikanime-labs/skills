...
description:
  "Use when iterating a problem to convergence inside its GitHub issue: classify
  open questions, resolve AFK research via delegate_task fan-out, then converge
  the body into a clean problem statement + decidable gate ledger."
version: 0.1.1
author: Hermes Agent
license: Apache-2.0
...
metadata:
  hermes:
    ...
    related_skills: ["sk-issue", "sk-issue-workflow", "sk-async"]
---
