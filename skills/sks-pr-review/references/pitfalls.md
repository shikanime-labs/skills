# Console review pitfalls

Cloud-pi-native console-specific gotchas; load with
`references/cloud-pi-native.md` when reviewing a console PR.
...
- **Migration sync regression** — Fastify→server-nestjs migration can pass all
  ...
  stops). See the console contribution workflow parity checklist before approving.
