...
Pour les dépôts dont les artefacts de review sont en français. Pas de `(...)`
dans les titres. Chaque constat est posté en commentaire inline sur SA ligne
(revue unique via l'API), pas en un seul gros commentaire. Voir
`references/inline-comments.md` pour les commandes `gh api`.
...
- [ ] Auteur : identité de l'org (cf. conventions d'org)
